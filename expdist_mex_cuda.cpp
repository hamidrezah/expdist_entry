...
double expdist_cuda(const double* A, const double* B, int m, int n, int dim, const double* scale_A, const double* scale_B);
		 ...
		 int nrhs, const mxArray *prhs[])
{
    ...
    printf("GPU Version m=%d, n=%d, Adim=%d, Bdim=%d\n", m, n, mxGetM(prhs[0]), mxGetM(prhs[1]));
    ...
    *result = expdist_cuda(A, B, m, n, dim, scale_A, scale_B);
}
